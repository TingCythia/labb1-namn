				...
				<div class="container">
					<div class="row">
						...
						<aside id="secondary" class="col-xs-12 col-md-3 col-md-pull-9">
							<ul class="side-menu">
								<li>
									<a href="<?php echo get_permalink( get_page_by_path( 'undersida' ) ); ?>">Undersida</a>
								</li>
								<li>
									<a href="<?php echo get_permalink( get_page_by_path( 'undersida2' ) ); ?>">Undersida 2</a>
								</li>
								<li>
									<a href="<?php echo get_permalink( get_page_by_path( 'undersida3' ) ); ?>">Undersida 3</a>
								</li>
								<li>
									<a href="<?php echo get_permalink( get_page_by_path( 'undersida4' ) ); ?>">Undersida 4</a>
								</li>
							</ul>
						</aside>
					</div>
